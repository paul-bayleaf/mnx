...
1. Anybody can raise an issue in
   [our issue tracker](https://github.com/w3c-cg/mnx/issues/).
2. The group co-chairs discuss and triage the issue. If it's out of
   ...
   the [list of milestones](https://github.com/w3c-cg/mnx/milestones/) for
...
3. We assign the "Active Review"
   [label](https://github.com/w3c-cg/mnx/labels/) to issues that the
